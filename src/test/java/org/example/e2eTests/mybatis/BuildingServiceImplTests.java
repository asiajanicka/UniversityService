...
import org.example.service.mybatis.BuildingServiceImpl;
...
public class BuildingServiceImplTests {

    private static final Logger logger = LogManager.getLogger(BuildingServiceImplTests.class);

    @Test
    public void usecase1Test() throws NoEntityCreatedException, EntityNotFoundException {

        logger.info("Start of Building Service My Batis Tests - test case 1");
        ...
        assertThatThrownBy(() -> buildingService.getBuildingById(actualBuilding.getId()))
                .isInstanceOf(EntityNotFoundException.class);
        logger.info("End of Building Service My Batis Tests - test case 1");
    }

    @Test
    public void usecase2Test() throws NoEntityCreatedException {

        logger.info("Start of Building Service My Batis Tests - test case 2");
        IBuildingService buildingService = new BuildingServiceImpl();
        IDepartmentService deptService = new DepartmentServiceImpl();
        ...
        logger.info("End of Building Service My Batis Tests - test case 2");
    }
