...
public class DepartmentServiceImplTests {
    ...
    private static final Logger logger = LogManager.getLogger(DepartmentServiceImplTests.class);

    @Test
    public void usecase1Test() throws NoEntityCreatedException, EntityNotFoundException {

        logger.info("Start of Department Service My Batis Tests - test case 1");
        ...
        logger.info("End of Department Service My Batis Tests - test case 1");
    }

    @Test
    public void usecase2Test() throws NoEntityCreatedException, EntityNotFoundException {

        logger.info("Start of Department Service My Batis Tests - test case 2");
        IDepartmentService deptService = new DepartmentServiceImpl();
        ...
        logger.info("End of Department Service My Batis Tests - test case 2");
    }
